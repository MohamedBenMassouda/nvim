...
keymap.set("n", "<leader>tn", ":tabn<CR>")                                     -- Go to Tab Next
keymap.set("n", "<leader>tp", ":tabp<CR>")                                     -- Go to Tab Previous
...
keymap.set("n", "<leader>k", ":Telescope keymaps<CR>", { desc = "Keymaps With Telescope" })
keymap.set("n", "<leader>fwa", ":Telescope grep_string<CR>", { desc = "Find Word Current Word" })
keymap.set("n", "<leader>fwc", ":Telescope current_buffer_fuzzy_find<CR>",
    { desc = "Find Word in Current Buffer with Telescope" })
keymap.set("n", "<leader>ft", ":Telescope flutter commands<CR>", { desc = "Open Flutter Tools Commands" })
keymap.set("n", "<leader>fc", ":Telescope commands<CR>", { desc = "Find Commands" })
keymap.set("n", "<leader>fd", ":Telescope diagnostics<CR>", { desc = "Find Diagnostics" })
keymap.set("n", "<leader>tr", ":Telescope resume<CR>", { desc = "Resume Last Telescope action" })
